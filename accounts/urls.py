...
urlpatterns = [
    ...
    path('adminconfirm', views.admin_confirm, name='adminconfirm'),
    path('medicoconfirm', views.medico_confirm, name='medicoconfirm'),
    path('pacienteconfirm', views.paciente_confirm, name='pacienteconfirm'),

    path('adminregister', views.admin_register, name='adminregister'),
    path('medicoregister', views.medico_register, name='medicoregister'),
    path('pacienteregister', views.paciente_register, name='pacienteregister'),
